...
{
	public static var psychEngineVersion:String = '2.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var weza:FlxSprite = new FlxSprite(700, -25);
		weza.frames = Paths.getSparrowAtlas('weza');
