...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(CoolUtil.difficultyString() == 'OPPONENT') {
            opponentChart = true;
		}
		...
		switch (curStage)
		{
			...
			case 'weza':
				...
				siema = new BGSprite('weza/siema', -120, -242, ['siema']);
				siema.setGraphicSize(Std.int(siema.width * 1.3));
				siema.updateHitbox();
				if(SONG.song.toLowerCase() == 'bobek') {
					remove(idk);
					add(siema);
				}
